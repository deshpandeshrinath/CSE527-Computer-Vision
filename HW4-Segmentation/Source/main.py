...
def create_background_filter(img, img_marking):
...
if __name__ == '__main__':
    ...
    out = create_background_filter(img, img_marking)
    # read video file
    output_name = sys.argv[3] + "mask.png"
    cv2.imwrite(output_name, out)
    sampleOutput = cv2.imread("example_output.png", 0)
    print RMSD(out, sampleOutput)